  ...
  subcategories: [
    {
      ...
      promptTemplate:
        "A prestigious certificate design celebrating achievement with formal elegance, intended as a commemorative educational visual for viewing only. {{#institution}}Institution: '{{institution}}'.{{/institution}} {{#recipientName}}Recipient: '{{recipientName}}'.{{/recipientName}} {{#subject}}Subject or achievement context: {{subject}}.{{/subject}} {{#ageGroup}}Age group: {{ageGroup}}.{{/ageGroup}} The design fills the entire canvas edge-to-edge with no decorative borders, frames, or background margins. Maintain refined educational certificate cues with elegant typography, ceremonial balance, and premium paper texture, but do not assume a full certificate script. Only render text elements that are explicitly provided or clearly requested. Do not invent placeholder names, generic titles, achievement paragraphs, dates, signature lines, or seal labels. If the institution name is the only provided text, show only the institution name and keep the rest of the composition free of visible text.",
    },
    {
